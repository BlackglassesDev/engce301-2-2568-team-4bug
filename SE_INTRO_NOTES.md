...
3. **Waterfall vs Agile – ตารางเปรียบเทียบ**
     ...
     |:---:|:---:|
     | จุดเด่น | 1) สามารถแสดงรายละเอียดขั้นตอนได้อย่างเป็นระบบเข้าใจง่าย |
             | 2) บันทึกรายละเอียดโครงการได้อย่างเป็นขั้นเป็นตอน และง่ายต่อการบำรุงรักษาหรือส่งมอบ |
     | ข้อจำกัด | 3) การเปลี่ยนแปลงข้อกำหนด (Requirements) ระหว่างขั้นตอนนั้นทำได้ยากและมีค่าใช้จ่ายสูง |
